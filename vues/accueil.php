...
?>
				...
				<img class="icone" onclick="document.location.href = 'index.php?page=switch&action=<?php echo $deviceInfo[$liste[$i]['type']]['action'] . "&data=" . $device['Status'] . "&idx=" . $device['idx']; ?>'" src="img/<?php echo $deviceInfo[$liste[$i]['type']]['etat']; ?>"></img>
