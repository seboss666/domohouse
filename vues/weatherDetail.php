...
<div class="column full">
	...
	<p>
		...
		<br/>
		<img src="http://l.yimg.com/a/i/us/we/52/<?php echo $weather['Current']['code']; ?>.gif" style="width: 52px; height: 52px; vertical-align: middle;"/>&nbsp;<?php echo $weather['Current']['text']; ?>
	</p>
	<h2>Forecast</h2>
